...
function [eps_r, mue_r, kappa] = build_epsmuekap( f_akt, data_struct)
%{
...
PLANE WAVES, REFLECTION and REFRACTION
    ...
    ###  emk_Data als Input-PARAMETER-Vektor mit 17 REAL DOUBLEs übergeben
    # André :
    #
    # data_struct als Input-PARAMETER-Struct mit 17 REAL DOUBLEs übergeben

Started on Dec. 23., 2018
Last Changes on Dec. 23., 2018
%}

%{
                       History :

 23. Dec.  2018 :  - Beginn Rolf als Kopie von 'build_epsmuekap_A02_02.m' :
                     Versions-Nummern/Bezeichnungen !
                     Diese History !
 ...
 13. Dec.  2018 :  - Beginn André als Kopie von 'build_epsmuekap_02_01.m' :
                     Eingabe-Werte aus data-struct lesen !
                         ...
                         ALT   build_epsmuekap_R02_01.m :
 11. Nov.  2018 :  - Beginn als Kopie von 'build_epsmuekap_01_03.m' :
                      3 Parameter MEHR in Datenbank ; Reihenfolge NEU 

 
                                    ALT in build_epsmuekap_01 :
...
f_low = data_struct.f_min;      f_high = data_struct.f_max;
...
eps_r_low = data_struct.eps_r_fmin;      eps_r_high = data_struct.eps_r_fmax;     eps_ftype = int32( data_struct.eps_r_Fkt_Typ + 0.001);
eps_par_1 = data_struct.eps_r_a;      eps_par_2 = data_struct.eps_r_b;      eps_par_3 = data_struct.eps_r_c;
...
mue_r_low = data_struct.my_r_fmin;     mue_r_high = data_struct.my_r_fmax;    mue_ftype = int32( data_struct.my_r_Fkt_Typ + 0.001);
mue_par_1 = data_struct.my_r_a;     mue_par_2 = data_struct.my_r_b;     mue_par_3 = data_struct.my_r_c;
...
kappa_low = data_struct.kappa_fmin;      kappa_high = data_struct.kappa_fmax;     kap_ftype = int32( data_struct.kappa_Fkt_Typ + 0.001); 
kap_par_1 = data_struct.kappa_a;      kap_par_2 = data_struct.kappa_b;      kap_par_3 = data_struct.kappa_c;
