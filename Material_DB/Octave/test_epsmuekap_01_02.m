...
% Versuch 3 { eps_r faellt nach Typ 33 auf Minimum ; kappa = Typ 4 steigend } :
...
emk_Data = emk_Data_ALL(:,12);      % OK, NEUE Daten :   eps_r = Typ 33 ; kappa = Typ 4 steigend      ????????  SCHROTT !!!
%
%emk_Data = emk_Data_ALL(:,13);      %  OK, NEUE Daten :   eps_r = Typ 3 ; kappa = Typ 4 fallend
%
