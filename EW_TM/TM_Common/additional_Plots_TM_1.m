function [p_handles, p_errors] = additional_Plots_TM_1( legend_flag, uv_1, uv_2, ...
...
PLANE WAVES, REFLECTION and REFRACTION
       Rolf Poddig
                       ...
                       statische Plots fuer TM-Faelle : 
    #           ( geeignet mindestens bei :
    #              -    alle Faelle 'delta', d.h. DREI Medien mit Daempfung )
    # Rolf :
    # 
    #    Winkel, Wellenzahlen, -Impedanzen
    #    Reflexions- und Transmissions-Koeffizienen SKALAR, ALSO DEFINIERT FUER MAGNETFELDER !
    #
    #
    #               PARAMETER Eingabe :
    #
...
Last Changes on Jun. 02., 2017
%}

%{
                       History :

 02. Jun.  2017 :  - Beginn der Auslagerung als Kopie von additional_Plots_TE_1.m :
...
%%                  %
                    ...
                    title('r-normal MAGNET.  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                    ...
                    title('t-normal MAGNET. Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('t- und r-normal TM  Betraege', "fontsize", 14);
                        if (legend_flag == 2)
                    ...
                    title('t- und r-normal TM  Phasen', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["t"; "r"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "t", "r");
                    ...
                    title('Z-FW-t-tr TM  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('Z-FW-t-lo TM  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('r2-normal MAGNET.  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('t2-normal MAGNET.  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('t2- und r2-normal TM  Betraege', "fontsize", 14);
                        if (legend_flag == 2)
                    ...
                    title('t2- und r2-normal TM  Phasen', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["t2"; "r2"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "t2", "r2");
                    ...
                    title('Z-FW-t2-tr TM  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
                    ...
                    title('Z-FW-t2-lo TM  Real- und Imaginaerteil', "fontsize", 14);
                        if (legend_flag == 2)
                            legend( ["Re"; "Im"], "location", "east");
                        elseif (legend_flag == 1)
                            legend( "Re", "Im");
