...
"                                                border: none;    }"))
        ...
        self.radioButton_festerWinkel.setEnabled(True)
        ...
        self.tableWidget.setGeometry(QtCore.QRect(70, 70, 1161, 441))
        self.tableWidget.setStyleSheet(_fromUtf8(""))
        self.tableWidget.setObjectName(_fromUtf8("tableWidget"))
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.btn_refresh = QtGui.QPushButton(self.tab_3)
        self.btn_refresh.setGeometry(QtCore.QRect(540, 550, 201, 31))
        self.btn_refresh.setStyleSheet(_fromUtf8(""))
...
"                        /*border-color: #434749;*/}"))
        ...
        self.btn_theoriePDF.setGeometry(QtCore.QRect(170, 420, 200, 60))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.frame_4.setGeometry(QtCore.QRect(690, 40, 540, 561))
        self.frame_4.setStyleSheet(_fromUtf8("QFrame{ color: #b6b9b8;\n"
"                        border: 2px solid #434749; \n"
"                        border-radius: 4px;\n"
"                        /*border-color: #434749;*/}"))
        ...
        self.lbl_Projektstruktur = QtGui.QLabel(self.frame_4)
        ...
        self.btn_projektstruktur = QtGui.QPushButton(self.frame_4)
    ...
    def retranslateUi(self, EbeneWellen):
        EbeneWellen.setWindowTitle(_translate("EbeneWellen", "EbeneWellen Advanced", None))
        ...
        self.btn_clearConsole.setText(_translate("EbeneWellen", "clear Console", None))
        ...
        self.btn_refresh.setText(_translate("EbeneWellen", "Tabelle Aktualisieren", None))
